...
public class highBiosecurity : MonoBehaviour {

	// create x/y coordinates with arrays
	float x;
	float y;
	float z;
	Vector3 pos;
	...
	void Start () {
		Debug.Log ("High Avg Bio");
		// create the grid of xy positions
		xPos = -8.3f;
		xArray = new float[38];
		yPos = -4.6f;
		yArray = new float[30];
